...
let openweather_url=
"https://api.openweathermap.org/data/2.5/wather?q=Seoul&units=metric&appid=7d96bc5108f52b80e2d9075a369b9f35"
/*비 동기식(Asynchrous)      동기식(Synchronus)*/
...
function getWeatherfind(){
  ...
  ajaxrequest.onreadystatechange = function(){
    if(ajaxrequest.readyState==4){
      ...
      weather.innerText = exdata.main[0]+","+exdata.description;
      debugger
    }
  };
}
